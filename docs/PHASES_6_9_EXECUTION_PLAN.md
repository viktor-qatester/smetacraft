...
Контракт этого шага оформлен в [`docs/PROJECT_MIGRATION.md`](PROJECT_MIGRATION.md); там же перечислены конвенции, выбранные по умолчанию и требующие подтверждения владельца. Документ не разрешает начинать 7.2.
