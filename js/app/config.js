      ...
      const ROOF_LEAD =
        "Кровля: стропила, мауэрлат, обрешётка, утепление и покрытие. Цены в Br — ориентир, правьте под поставщика.";
      const FLOOR_LEAD =
      ...
      const INTAKE_LEAD =
        "Анкета: ответьте на простые вопросы о доме — калькулятор сам подставит размеры и покажет ведомость материалов.";
